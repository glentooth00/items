...
new class extends Component {
    ...
    {
        $areaOffices = AreaOffices::paginate(8);

        return view('components.area-office.⚡index', [
    ...
    public function save()
    {
        // Validate the input
        $this->validate([
            'area_office' => 'required|unique:area_offices,area_office|string|max:255',
            'area_code' => 'nullable|unique:area_offices,area_code|string|max:255',
        ]);

        AreaOffices::create([
            'area_office' => $this->area_office,
    ...
    {
        AreaOffices::findOrFail($this->deleteId)->delete();
        ...
        Flux::toast(
            heading: 'Success',
            text: 'Extension Office deleted successfully.',
            variant: 'success'
        );
    }
...
<section class="w-full">
    ...
    <x-settings.layout :heading="__('Area Office')" :subheading="__('Manage Area offices.')">
        <div class="space-y-6">
                ...
                <div class="flex items-end gap-4">
                    <form wire:submit="save" class="flex flex-col md:flex-row items-end gap-4 w-full">
                        ...
                        <div class="flex-1 w-full">
                            <flux:input
                                wire:model.defer="area_office"
                                label="Area Office"
                                placeholder="e.g. Area Office B, Resort A, Building C, etc..."
                            />
                        </div>

                        <div class="flex-1 w-full">
                            <flux:input
                                wire:model.defer="area_code"
                                label="Area Code"
            ...
            <flux:card>
                ...
                <div class="flex items-center justify-between px-6 py-4 border-b">
                    ...
                    <div>
                        ...
                        <flux:text class="mt-1">
                            Manage the assets to the assigned available offices or properties.
                        </flux:text>
                    </div>
                ...
                <table :paginate="$areaOffices" class="w-full">
                    ...
                    <flux:pagination class="cursor-pointer" :paginator="$areaOffices" />
